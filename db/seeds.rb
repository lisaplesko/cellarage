...
lisa.wines << v3.wines.create!(name: 'La Castellana',grape: 'Cabernet',vintage: 2005,region: 'Napa Valley', on_hand: 3,category: 'Red',occasion: 'Nice dinner')
lisa.wines << v3.wines.create!(name: 'Il Passito',grape: 'Semillon',vintage: 2006,region: 'Sonoma County', on_hand: 1,category: 'Dessert',occasion: 'Nice dinner')
lisa.wines << v3.wines.create!(name: 'Il Raggio Del Sole',grape: 'Muscat',vintage: 2009,region: 'Santa Barbara County', on_hand: 2,category: 'White',occasion: 'Nice dinner')
lisa.wines << v3.wines.create!(name: 'Gewurztraminer',grape: 'Gewürztraminer',vintage: 2009,region: 'Anderson Valley', on_hand: 1,category: 'White',occasion: 'Nice dinner')
lisa.wines << v3.wines.create!(name: 'Gewurztraminer Dolcino',grape: 'Gewürztraminer',vintage: 2008,region: 'Anderson Valley', on_hand: 1,category: 'White',occasion: 'Nice dinner')
...
lisa.wines << v8.wines.create!(name: 'The David',grape: 'Cabernet',vintage: 2008,region: 'Napa Valley', on_hand: 1,category: 'Red',occasion: 'Holiday')
...
lisa.wines << v13.wines.create!(name: 'Villa Antinori',grape: 'Other',vintage: 2009,region: 'Tuscany', on_hand: 1,category: 'Red',occasion: 'Every day')
lisa.wines << v13.wines.create!(name: 'Villa Antinori',grape: 'Other',vintage: 2007,region: 'Tuscany', on_hand: 1,category: 'Red',occasion: 'Every day')
